# Generated by Django 3.2.3 on 2024-09-21 13:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite', models.ManyToManyField(blank=True, related_name='favorites', to='recipes.Recipe', verbose_name='Избранное')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('shopping_cart', models.ManyToManyField(blank=True, related_name='shopping', to='recipes.Recipe', verbose_name='Список покупок')),
            ],
            options={
